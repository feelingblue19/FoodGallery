                ...
                <!-- Main content -->
					...
					<div class="form-wrapper">
                        <?php
							if(isset($_GET['id']))
								$id = $_GET['id'];
                            $sql=$koneksi->query("SELECT * FROM recipe WHERE id='$id'");
                            $data=$sql->fetch_array();
						?>
						<form action="editrecipe-process.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
							<table>
								...
								<tr>
									<td>Judul Recipe</td>
									<td>
										<input class="form-control" type="text" name="judul" value="<?php echo $data['judul']; ?>" size="50">
									</td>
								</tr>
								<tr>
									<td>Tanggal</td>
									<td>
										<input class="form-control" type="text" name="tanggal" value="<?php echo $data['tanggal']; ?>"  size="50">
									</td>
								</tr>
								<tr>
									<td>Foto</td>
