         ...
         function fn_ValForm()
           {
                ...
                {
                    sMsg += ("\n* Anda belum mengisikan Location");
                }
            ...
            <div id="content-wrapper">
				...
				<main class="container-fluid">
					...
					<div class="form-wrapper">
							<form action="writereview-process.php" method="post" enctype="multipart/form-data">
							<table>
								<?php
								...
								<tr>
									<td>Location</td>
									<td>
										<input class="form-control" type="text" name="location" id="location" size="50" required="">
									</td>
									</tr>
								<tr>
									<td>Tanggal</td>
								...
								<tr>
									<td>Harga</td>
									<td>
										<input class="form-control" type="text" name="harga" id="harga" size="50" required="">
									</td>
								</tr>
								<tr>
									<td>Foto</td>
									...
									<input class="form-control" type="file" name="photo1" accept="image/*" size="50"/>
									</td>
								</tr>
								<tr>
