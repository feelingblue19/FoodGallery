		 ...
		 function fn_ValForm()
           {
                ...
                {
                    sMsg += ("\n* Anda belum mengisikan First Name");
                }if(document.getElementById("last_name").value == "")
                {
                    sMsg += ("\n* Anda belum mengisikan Last Name");
                }
					...
					<div class="form-wrapper">
						<form action="createaccount-process.php" method="post">
							<table>
								...
								<tr>
									<td>
										<input class="form-control" type="text" name="first_name" id="first_name" size="50" required="">
									</td>
								</tr>
								<tr>
									<td>Last Name</td>
								...
								<tr>
									<td>
										<input class="form-control" type="text" name="last_name" id="last_name" size="50" required="">
									</td>
								</tr>
								<tr>
									<td>Email</td>
								...
								<tr>
									<td>
										<input class="form-control" type="text" name="email" id="email" size="50" required="">
									</td>
								</tr>
								<tr>
									<td>Password</td>
								...
								<tr>
									<td colspan="2" align="center"><button type="submit" name="simpan" class="btn btn-primary" onclick="fn_ValForm()">SIMPAN</button></td>
								</tr>
							</table>
						</form>  
					</div>
